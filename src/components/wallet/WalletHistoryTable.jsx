...
export default function WalletHistoryTable({ walletId, currency }) {
  ...
  const badge =
    entries.length > 0 ? `${entries.length} operations` : "Aucun mouvement sur la periode";
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <form onSubmit={handleSubmit} className="flex items-center gap-2">
            ...
            <button type="submit" className="px-3 py-1 rounded-lg bg-slate-900 text-white text-sm">
              Filtrer
            </button>
          </form>
          <button
