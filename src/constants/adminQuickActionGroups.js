...
const ADMIN_QUICK_ACTION_GROUPS = [
  {
    ...
    actions: [
      ...
      { label: "Notifications", to: "/dashboard/admin/notifications", icon: Bell, description: "Centre d'alertes" },
      ...
      { label: "Securite live", to: "/dashboard/admin/security", icon: ShieldAlert, description: "Etat securite" },
