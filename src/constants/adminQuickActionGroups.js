...
const ADMIN_QUICK_ACTION_GROUPS = [
  {
    ...
    actions: [
      ...
      { label: "Correction bonus", to: "/dashboard/admin/users/bonus-corrections", icon: Gift, description: "Ajustements credit/debit bonus" },
  ...
  },
  {
    ...
    actions: [
      ...
      { label: "Cartes virtuelles", to: "/dashboard/admin/virtual-cards", icon: CreditCard, description: "Supervision cartes web" },
      { label: "Support cases", to: "/dashboard/admin/support-cases", icon: LifeBuoy, description: "Reclamations client" },
      { label: "Offline agent", to: "/dashboard/admin/agent-offline-ops", icon: Briefcase, description: "Sync terrain agents" },
