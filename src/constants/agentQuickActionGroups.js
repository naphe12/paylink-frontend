...
export const AGENT_QUICK_ACTION_GROUPS = [
  ...
  },
  {
    ...
    actions: [
      ...
      { label: "Mode hors ligne", to: "/dashboard/agent/offline", icon: CloudOff, description: "File terrain et sync" },
      ...
      { label: "Transfert bonus", to: "/dashboard/agent/bonus-transfer", icon: Gift, description: "Debiter le bonus client" },
