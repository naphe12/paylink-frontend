...
describe("AdminAgentOfflineOpsPage", () => {
  ...
  it("loads offline operations and retries a failed sync", async () => {
      ...
      .mockResolvedValueOnce([
        {
          ...
          conflict_reason_label: "Le client n'a plus assez de solde au moment de la sync",
          requires_review: true,
          is_stale: true,
          queued_age_minutes: 220,
          snapshot_available: 50000,
          current_available: 12000,
          balance_delta: -38000,
    ...
    expect(await screen.findAllByText(/A verifier/i)).not.toHaveLength(0);
